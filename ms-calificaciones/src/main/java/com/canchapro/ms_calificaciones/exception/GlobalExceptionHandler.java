package com.canchapro.ms_calificaciones.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleCalificacionNoEncontrada(
        ...
        response.put("error", "Calificación no encontrada");
    ...
    public ResponseEntity<Map<String, Object>> handleCalificacionException(
            CalificacionException ex
    ) {

        Map<String, Object> response = new HashMap<>();
        response.put("timestamp", LocalDateTime.now());
        response.put("status", HttpStatus.CONFLICT.value());
        response.put("error", "Error de calificación");
        response.put("message", ex.getMessage());
